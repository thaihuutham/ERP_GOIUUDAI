...
- [ ] F5.6 Tách thêm `scm/hr/crm` khỏi skeleton generic (`finance` đã DONE)
- [ ] F5.7 Hoàn thiện E2E UI flow cho toàn bộ module trọng yếu
...
| F5-007 | Mở rộng tương tự cho finance/scm/hr/crm | `apps/web/app/modules/*` | `npm run build --workspace @erp/web` | IN_PROGRESS (finance DONE) |
...
2. Skeleton generic được thay bằng màn hình nghiệp vụ cho các module trọng yếu. IN_PROGRESS  
3. Có ít nhất 1 flow E2E hoàn chỉnh trên UI cho module trọng yếu. IN_PROGRESS  
